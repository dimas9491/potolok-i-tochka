...
(function(){
  ...
  var SUB_TEXT = {
    apartment: 'Пришлите фото комнаты в Telegram — технолог посчитает по вашим размерам, нарисует 3D-визуализацию и пришлёт договор с фиксированной ценой. Замерщик приезжает только на монтаж.',
    house: 'Многоуровневые конструкции и бесщелевые примыкания для загородного дома. Считаем по плану БТИ и фото — пришлём 3D, смету и график монтажа за 48 часов. Замерщик выезжает уже под подписанный договор.',
    designer: 'Технолог изучит ваш дизайн-проект и рендеры — потолок будет точно как в визуализации. За 48 часов пришлём 3D, спецификацию материалов и точную смету. Согласуем график с прорабом.'
  };
