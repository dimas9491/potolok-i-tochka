...
(function(){
  ...
  var SUB_TEXT = {
    apartment: 'Пришлите фото комнаты — в течение часа технолог пришлёт визуализацию: как будет выглядеть потолок именно у вас. Несколько вариантов: матовый, парящий, со световыми линиями. Дальше — бесплатный выезд мастера: посчитает точную цену при вас и зафиксирует в договоре.',
    house: 'Многоуровневые конструкции для дома — нарисуем визуализацию по фото комнат и плану БТИ. Ответим в течение часа. Покажем варианты с бесщелевыми примыканиями и световыми линиями. Замер по дому — бесплатно, выезжаем в МО.',
    designer: 'Технолог изучит ваш дизайн-проект и рендеры дизайнера — пришлёт визуализацию точно под ваш интерьер в течение часа. Покажем как будет с разными фактурами и светом. На замер согласуем график с прорабом.'
  };
