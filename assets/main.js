...
(function(){
  ...
  var SUB_TEXT = {
    apartment: 'Пришлите фото комнаты — в течение часа технолог пришлёт визуализацию: как будет выглядеть потолок именно у вас. Несколько вариантов: матовый, парящий, со световыми линиями. Понравится — приедем на бесплатный замер и посчитаем точную цену в договоре.',
